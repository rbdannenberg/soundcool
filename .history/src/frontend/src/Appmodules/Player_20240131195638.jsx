      ...
      <React.Fragment>
        ...
        >
          ...
          <div style={{ flex: 1, padding: "20px" }}>
            ...
            >
              <div style={{ cursor: "pointer", border: "1px solid", width: "2.5rem", fontSize: "0.64rem" }}>
                &#215;0.01
              </div>
              <div style={{ cursor: "pointer", border: "1px solid", width: "1.25rem", fontSize: "0.64rem" }}>
                &#215;1
              </div>
              <div style={{ cursor: "pointer", border: "1px solid", width: "1.25rem", fontSize: "0.64rem" }}>
                &#215;2
