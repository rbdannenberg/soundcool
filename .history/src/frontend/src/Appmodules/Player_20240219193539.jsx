      ...
      <React.Fragment>
        ...
        >
          ...
          <div style={{ flex: 1, padding: "5rem" }}>
            <div className="speed-display" style={{ marginBottom: "5rem" }}>
            ...
            >
              ...
              <button
                ...
                onClick={() => {}}
              >
                <FaPlay style={{ fontSize: "0.64rem", marginLeft: "2rem" }} />
              </button>
            ...
            <div style={{ display: "flex", alignItems: "center", marginBottom: "10rem" }}>
              <div className="volume-meter" style={{ width: "10px", minHeight: "10rem", marginTop:"1rem",marginLeft:"44rem",backgroundColor: "black" }}>
