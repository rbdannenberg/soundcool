    ...
    return (
      <React.Fragment>
        ...
        >
          ...
          <div class="Loop"style={{marginTop:"7rem",marginLeft:"-20rem"}}>
          <button type="button" class="btn btn-outline-info">Loop</button>
         </div>
          
          <div style={{ flex: 1, padding: "5rem" }}>
            <div className="speed-display" style={{ marginBottom: "2rem",marginTop:"-3rem"}}>
