  ...
  return (
    <React.Fragment>
      ...
      >
         ...
         <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', margin: '1rem 0' }}>
          <div style={{ display: 'flex', alignItems: 'center', marginRight: '0.5rem' }}> {/* Reduced right margin */}
            ...
            <input
              ...
              type="checkbox"
              id="random"
              style={{ height: "0.8rem", width: "0.8rem", marginLeft: "0.5rem" }}
              onClick={() => {}}
            />
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', marginLeft: '0.5rem' }}> {/* Reduced left margin */}
            ...
            onClick={() => {}}
          >
            <FaPlay style={{ fontSize: "12px", marginLeft: "1px", marginTop: "-4px" }} />
        ...
        <div style={{ display: 'flex', justifyContent: 'space-around', width: '100%', margin: '1rem 0' }}>
          <span className="" style={{ cursor: "pointer", fontSize: "1.6rem", margin: '0.1rem' }} onClick={() => {}}>x0</span>
          <span className="" style={{ cursor: "pointer", fontSize: "1.6rem" , margin: '0.1rem'}} onClick={() => {}}>x1</span>
          <span className="" style={{ cursor: "pointer", fontSize: "1.6rem" , margin: '0.1rem'}} onClick={() => {}}>x2</span>
        </div>
