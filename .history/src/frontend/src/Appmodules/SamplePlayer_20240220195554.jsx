    ...
    <React.Fragment>
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-around', width: '100%', margin: '1rem 0' }}>
          <span className="" style={{ cursor: "pointer", fontSize: "1.6rem", margin: '0rem' }} onClick={() => {}}>x0</span>
          <span className="" style={{ cursor: "pointer", fontSize: "1.6rem" , margin: '0rem'}} onClick={() => {}}>x1</span>
          <span className="" style={{ cursor: "pointer", fontSize: "1.6rem" , margin: '0rem'}} onClick={() => {}}>x2</span>
        </div>
