    ...
    <React.Fragment>
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-around', width: '100%', margin: '1rem ' }}>
          ...
          <span className="" style={{ cursor: "pointer", fontSize: "1.6rem" , marginLeft: '-25rem'}} onClick={() => {}}>x1</span>
          <span className="" style={{ cursor: "pointer", fontSize: "1.6rem" , marginLeft: '-25rem'}} onClick={() => {}}>x2</span>
        </div>
