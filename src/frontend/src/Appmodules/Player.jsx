    ...
    return (
      <React.Fragment>
        ...
        >
          ...
          <div style={{ marginTop: "12rem",marginLeft:"-25rem",marginBottom:"-2rem" }}>
          <input type="checkbox" id="Loop" name="Loop" value="Loop" />
          <label htmlFor="Loop">Loop</label><br />
         ...
         <div style={{ flex: 1, padding: "5rem" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", marginBottom: "10rem" }}>
              <div className="volume-meter" style={{ width: "1rem", minHeight: "15rem", marginTop:"1rem",marginLeft:"44rem",backgroundColor: "black" }}>
              ...
              >
                ...
                <input
                  ...
                  orient="vertical"
                  type="range"
                  style={{ width: "1.5rem", height: "15rem"}}
                  min={0}
                  max={100}
                  step={1}
