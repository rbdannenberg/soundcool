...
// class ScTransposer extends ScModule {
...
//     // let weirdPhaser = new AudioWorkletNode(this.context, ".");
//     console.log("here 1");

//     //Connect to the context's destination and start
//     // oscillator.connect(weirdPhaser).connect(this.context.destination);
//     let ctx = this.context;

//     var mediaSource = oscillator;

//     var pluginURL = ".";
//     var plugin = new LarkinWeirdPhaser(ctx, pluginURL);
...
//     //   .addModule("./wasm-worklet-processor.js")
//     //   .then(() => {
//     //     console.log("here 0");
//     //     //Create an oscillator and run it through the processor
//     //     let oscillator = new OscillatorNode(this.context);
//     //     // let bypasser = new AudioWorkletNode(context, "wasm-worklet-processor");
//     //     // console.log("here 1");
//     //     // //Connect to the context's destination and start
