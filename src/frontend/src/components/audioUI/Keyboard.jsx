...
const Keyboard = ({ blockInfo, changeBlock }) => {
  let {
    id,
    instrument,
    channel,
  ...
  const changeInstrument = (i, id) => changeBlock(id, "instrument", i);

  const changeMIDIMessage = (m, id) => changeBlock(id, "midiMessage", m);
      ...
      >
        ...
        {[...Array(8).keys()].map(i => (
          <div
            ...
            onClick={() => {
              changeBlock(id, "noteOn", undefined, { num: i });
        ...
        {[...Array(2).keys()].map(i => (
          <div
            ...
            onClick={() => {
              changeBlock(id, "noteOn", undefined, { num: i + 8 });
        ...
        {[...Array(3).keys()].map(i => (
          <div
            ...
            onClick={() => {
              changeBlock(id, "noteOn", undefined, { num: i + 10 });
