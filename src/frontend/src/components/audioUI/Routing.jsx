        ...
        <div className="" style={{ position: "absolute" }}>
          <div style={{ position: "absolute", top: "5px" }}>
            ...
            <button
              ...
              onClick={() => connectBlock("nowIn",[name, "0", id, audioObj])}
            >
          ...
          <div style={{ position: "absolute", top: "136px" }}>
            ...
            <button
              ...
              onClick={() => connectBlock("nowOut",[name, "0", id, audioObj])}
            >
        ...
        <div className="" style={{ position: "absolute", left: "130px" }}>
          <div style={{ position: "absolute", top: "5px" }}>
            ...
            <button
              ...
              onClick={() => connectBlock("nowIn",[name, "1", id, audioObj])}
            >
          ...
          <div style={{ position: "absolute", top: "136px" }}>
            ...
            <button
              ...
              onClick={() => connectBlock("nowOut",[name, "1", id, audioObj])}
            >
