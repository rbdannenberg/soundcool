            ...
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <p>
                    This pop-up is used to inform visitors regarding our
                    policies on the collection, use, and disclosure of
                    information. If you choose to use our service, then you
                    agree to the collection and use of information related to
                    this policy. This service is provided by the
                    PerformingARTech research group of the Universitat
                    Politècnica de València, free of charge, and is designed to
                    be used as is. This privacy policy establishes the terms in
                    which Soundcool Web Version uses and protects the
                    information that is provided by its users. This company is
                    committed to the safety of its users’ data.
                  </p>
                  ...
                  <p>
                    ...
                    Agency Spanish Data Protection.
                  </p>
                </div>
          ...
          <div className="section1-container">
            <div className="row">
              ...
              <p className="col text-center" id="home-subheader-container">
                <font className="text" style={{ verticalAlign: "inherit" }}>
            ...
            <div className="row">
              ...
              <div className="col-12 text-center">
                <div className="row icons">
                  <div className="card" style={{ width: 15 + "vw" }}>
                    <img className="card-img-top" src={tablet} alt="tablet-image" />
                    <div class="card-body">
                  ...
                  <div class="card" style={{ width: 15 + "vw" }}>
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text card-subheader">
            ...
            <div id="scroll_button_container">
              <button id="scroll_button" onClick={this.scroll}>
                Learn More
              </button>
            </div>
          </div>
        ...
        <div id="section2">
          <div id="down">
            <div className="section2-container">
              <div className="row">
                <h2
                  className="title col text-center text"
                  id="home-section2-title-container"
                >
                  <font style={{ verticalAlign: "inherit" }}>
                    <font
                      id="section2-title"
              ...
              <div className="row">
                <div className="subtitle col offset-md-3 col-md-6 text-center text">
                  <font style={{ verticalAlign: "inherit" }}>
                    ...
                    >
                      Musicians and audiovisual creators, education at all
                      levels, inclusive education
                    </font>
                  </font>
                </div>
              </div>
              ...
              <div className="row rows-container">
                <div class="card" style={{ width: 15 + "vw" }}>
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text card-subheader">
                      ...
                      <br></br>
                      Blend videos, images, and video loops live for stunning
                ...
                <div class="card" style={{ width: 15 + "vw" }}>
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text card-subheader">
                      <strong>
                        Join the future:<br></br>
                      </strong>{" "}
                      Pioneering technology for neurodegenerative
                      rehabilitation. Join us{" "}
                      <a href="https://soundcool.org/contact/">here</a>.
                    </p>
                  </div>
                </div>
                ...
                <div class="card" style={{ width: 15 + "vw" }}>
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text card-subheader">
                      <strong>Fuel student motivation:</strong> <br></br>
                      Collaborate on music, audiovisuals, and live soundtracks.
                      Boosts arts, language, and more across all levels. Learn
                      how <a href="https://soundcool.org/contact/">here</a>.
                    </p>
                  </div>
                </div>
                ...
                <div class="card" style={{ width: 15 + "vw" }}>
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text card-subheader">
                      <strong>Comprehensive education:</strong>
                      <br></br>Empower students with autism, Down syndrome,
                      blindness, and more.
                    </p>
                  </div>
                </div>
