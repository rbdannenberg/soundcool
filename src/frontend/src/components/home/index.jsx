          ...
          <div className="container">
            <div className="row">
              <h2 className="title col text-center">
                <font style={{ verticalAlign: "inherit" }}>
                  <font style={{ verticalAlign: "inherit" }}>Who is it for?</font>
                </font>
              </h2>
            </div>
            <div className="row">
                  ...
                  <div className="col-sm-4">
                    ...
                    <div className="text">
                      ...
                      <p>
                        <font style={{ verticalAlign: "inherit" }}>
                          <font style={{ verticalAlign: "inherit" }}>
                            Make your audiovisuals creatively mixing videos,
                            images or video loops, controlling everything live
                            with the mobile / tablet
                          </font>
                        </font>
                      </p>
                    </div>
                  ...
                  <div className="col-sm-4">
                    ...
                    <div className="text">
                      ...
                      <p>
                        <font style={{ verticalAlign: "inherit" }}>
                          <font style={{ verticalAlign: "inherit" }}>
                            Increase the motivation of your students using
                            Soundcool and mobile / tablets for the collaborative
                            creation of music, audiovisual, soundtracks made
                            live for movies, theater or LOVA operas, etc.{" "}
                          </font>
                          <font style={{ verticalAlign: "inherit" }}>
                  ...
                  <div className="col-sm-4">
                    ...
                    <div className="text">
                      ...
                      <p>
                        <font style={{ verticalAlign: "inherit" }}>
                          <font style={{ verticalAlign: "inherit" }}>
                            Inclusive pedagogies with Soundcool have
                            demonstrated their suitability to improve the
                            abilities of students with autism, Down syndrome,
