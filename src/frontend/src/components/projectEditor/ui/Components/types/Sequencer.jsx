...
const Beat = ({
    ...
    return (
        <div style={{ position: "absolute", width: "70px", height: "160px" }}>
            <div
                style={{ position: "absolute", width: "70px", height: "100px" }}
            >
                {/* <Knob /> */}
                <Knob
                    style={{
                ...
                />
                <div
                    style={{ position: "absolute", top: "40px", left: "18px" }}
                >
                    {getNote(note)}
                </div>
                <Knob
                ...
                >
                    ...
                    >
                        ...
                        <div
                            className="dropdown-item"
                            onClick={() =>
                                changeWaveform("White Noise", id, num)
                            }
                        >
                            White Noise
                        </div>
                        <div
                            className="dropdown-item"
                            onClick={() =>
                                changeWaveform("Pink Noise", id, num)
                            }
                        >
                            Pink Noise
                        </div>
            ...
            >
                <div style={{ position: "absolute", top: "2px" }}>
                    ...
                    <input
                        ...
                        onChange={e =>
                            changeBlock(id, "signalGenId", e.target.value)
                        }
                    />
                    <label
                        htmlFor="envId"
