      ...
      <div id="projects-page-container">
        ...
        <div id="projects-main-container">
          <div id="projects-library-header">
            <p
              className="text"
              style={{ fontSize: 4 + "rem", fontStyle: "bold" }}
            >
              LIBRARY
            </p>
          </div>
          ...
          <div id="projects-name-label" className="text projects-label">
            NAME
          </div>
          <div id="projects-description-label" className="text projects-label">
            DESCRIPTION
          </div>
          <div id="projects-collaborator-label" className="text projects-label">
            COLLABORATORS
          </div>
          <div id="projects-date-label" className="text projects-label">
            CREATED
          </div>
          <div id="projects-launch-label" className="text projects-label">
            LAUNCH
          </div>
        ...
        <Card.Img variant="top" src={dummy} alt="Description of Image" />
        {/* </Card> */}
        {/* </CardDeck>
          </Col> */}
        <Col>
